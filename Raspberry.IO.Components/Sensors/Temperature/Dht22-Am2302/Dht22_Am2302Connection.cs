...
namespace Raspberry.IO.Components.Sensors.Temperature.Dht
{
    ...
    /// </remarks>
    public class Dht22_Am2302Connection : IDisposable
    {
        #region References
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Dht22_Am2302Connection"/> class.
        /// </summary>
        /// <param name="pin">The pin.</param>
        public Dht22_Am2302Connection(IInputOutputBinaryPin pin)
        {
            this.pin = pin;
            pin.AsOutput();
        }
        ...
        /// Gets the data.
        /// </summary>
        /// <returns>The Dht22_Am2302 data.</returns>
        public Dht22_Am2302Data GetData()
        {
            Dht22_Am2302Data data = null;
            var retryCount = 10;
        ...
        private Dht22_Am2302Data TryGetData()
        {
            // Prepare bugger
            var data = new byte[5];
            for (var i = 0; i < 5; i++)
            ...
            try
            {
                // Read acknowledgement from Dht22_Am2302
                pin.Wait(true, 100m);
                pin.Wait(false, 100m);
